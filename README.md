...
<img width="400" height="238" alt="bfs_1" src="https://github.com/user-attachments/assets/b2ea68b4-78a7-424a-b27d-88312da24f3a" />
...
<img width="200" height="119" alt="Screen Recording 2026-06-29 164426" src="https://github.com/user-attachments/assets/16175659-64eb-4409-bdd9-9fcd243a9b49" />
...
* **Độ phức tạp không gian:** $O(b \cdot m)$ (chỉ lưu đường đi hiện tại và các nút chưa mở rộng cùng cấp).

#### 3. UCS (Uniform Cost Search)

<img width="400" height="239" alt="ucs" src="https://github.com/user-attachments/assets/d25bb254-f979-49c0-86b2-25555631f328" />
...
* **Độ phức tạp thời gian:** $O(b^{1 + \lfloor C^* / \epsilon \rfloor})$ (với $C^*$ là chi phí tối ưu, $\epsilon$ là chi phí bước tối thiểu).
* **Độ phức tạp không gian:** $O(b^{1 + \lfloor C^* / \epsilon \rfloor})$ (lưu tất cả các nút đã duyệt).

#### 4. IDS (Iterative Deepening Search)

<img width="400" height="238" alt="ids_1" src="https://github.com/user-attachments/assets/7e9ce0b9-31d8-499a-95fc-1d7f9440c387" />
...
<img width="400" height="238" alt="greedy" src="https://github.com/user-attachments/assets/8ed36bfe-eda3-4850-9ac5-ccb3d7611c68" />
...
<img width="400" height="239" alt="Astar" src="https://github.com/user-attachments/assets/97695513-7cf9-4028-9184-7ca52b772d6e" />
...
<img width="400" height="240" alt="idastar" src="https://github.com/user-attachments/assets/6064c19c-13f5-455b-a098-23490123f816" />
...
* Leo đồi đơn giản, dốc nhất, ngẫu nhiên:

<img width="400" height="463" alt="simple" src="https://github.com/user-attachments/assets/a0ceb5e7-87fc-4ea8-9dfd-4caa9584e826" />

* Leo đồi khởi tạo ngẫu nhiên:

<img width="400" height="464" alt="random res" src="https://github.com/user-attachments/assets/6fcca95d-f227-474e-8feb-19e2ae121c08" />
...
<img width="400" height="468" alt="beam" src="https://github.com/user-attachments/assets/ee02edc0-b8ce-4658-a787-af748783b74f" />
...
* **Độ phức tạp không gian:** $O(k \cdot b)$ (lưu giữ $k$ trạng thái và các nút con của chúng).

#### 3. Simulated Annealing (Luyện kim giả lập)

<img width="400" height="466" alt="annealing" src="https://github.com/user-attachments/assets/80bdb51b-530e-4019-a37b-3343774c64ad" />
...
<img width="400" height="330" alt="Screen Recording 2026-06-29 165923" src="https://github.com/user-attachments/assets/87e119c4-689e-4742-ae71-3df4b7b2c46c" />
...
<img width="400" height="195" alt="Screen Recording 2026-06-29 170520" src="https://github.com/user-attachments/assets/80038263-dca3-4379-9601-b991d825ba66" />
...
<img width="400" height="244" alt="for" src="https://github.com/user-attachments/assets/cb1cf878-1046-4bba-8d9e-e322e98c2fb3" />
...
<img width="400" height="247" alt="min" src="https://github.com/user-attachments/assets/9d0c3ad0-e121-4bff-9135-ec6ac1d55790" />
...
<img width="400" height="222" alt="mini" src="https://github.com/user-attachments/assets/de727736-ac92-44f1-a76c-cea9d39210fb" />
...
<img width="400" height="225" alt="alpha" src="https://github.com/user-attachments/assets/33f59e9d-3850-4b09-b698-c766c433f7ba" />
...
<img width="892" height="462" alt="Adobe Express - ex" src="https://github.com/user-attachments/assets/4d6b9955-cb2b-4cd2-a880-e4268ea1cec0" />
